...
import 'package:shop_app/Features/home/data/data_sorces/remote_data_sources/get_user_data_data_source.dart';
...
import '../../../Features/home/data/data_sorces/remote_data_sources/get_favourite_data_source.dart';
import '../../../Features/home/data/data_sorces/remote_data_sources/home_remote_data_source.dart';
import '../../../Features/home/data/data_sorces/remote_data_sources/login_data_source.dart';
import '../../../Features/home/data/data_sorces/remote_data_sources/register_data_source.dart';
import '../../../Features/home/data/repos/favourites_repo/favourites_repo.dart';
import '../../../Features/home/data/repos/favourites_repo/favourites_repo_impl.dart';
import '../../../Features/home/data/repos/search_repo/search_repo.dart';
...
void setUpServiceLocator() {
  ...
  // getIt.registerSingleton<FavouritesUseCase<GetFavouritsModel>>(
  //   FetchFavouritesUseCase(favouritesRepo: getIt.get<FavouritesRepo>()),
  // );
  ...
  getIt.registerFactory(() {
    final fetchProductsUseCase = FetchProductsUseCase(getIt.get<HomeRepo>());
